    ...
    <React.Fragment>
      {fileDownload ? (
        <Animated.View style={tailwind.style('pr-1.5')}>
          <Spinner
            size={20}
            stroke={isIncoming ? tailwind.color('text-white') : tailwind.color('bg-orange-800')}
          />
        </Animated.View>
      ) : (
        <Animated.View style={tailwind.style('pr-1.5')}>
          <Icon
            ...
            icon={
              <FileIcon
                fill={isIncoming ? tailwind.color('bg-white') : tailwind.color('text-orange-800')}
              />
            }
          />
        </Animated.View>
