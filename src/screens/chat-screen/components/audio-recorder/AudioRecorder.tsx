...
export const AudioRecorder = ({
  ...
  return (
    <Animated.View
      ...
      <Animated.View
        style={tailwind.style(
          'bg-orange-800 px-3 py-[7px] rounded-2xl min-h-9 flex flex-row items-center justify-between mx-1.5',
      ...
      <Pressable
        ...
        <Animated.View
          style={tailwind.style(
            'flex items-center justify-center h-7 w-7 rounded-full bg-orange-800',
          )}>
