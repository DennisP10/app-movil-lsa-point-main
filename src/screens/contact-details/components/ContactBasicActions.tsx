      ...
      <Pressable
        ...
        <Animated.Text
          ...
          style={tailwind.style(
            'text-cxs font-inter-medium-24 leading-[15px] tracking-[0.32px] text-center text-orange-800 pt-2',
          )}>
          {option.contactType}
        </Animated.Text>
      </Pressable>
      ...
      <Animated.View style={tailwind.style('flex flex-row justify-between ')}>
        <ContactOptionComponent
          ...
          option={{
            ...
            icon: <MailIcon strokeWidth={2} stroke={tailwind.color('bg-orange-800')} />,
          }}
        ...
        <ContactOptionComponent
          ...
          option={{
            ...
            icon: <PhoneIcon strokeWidth={2} stroke={tailwind.color('bg-orange-800')} />,
          }}
